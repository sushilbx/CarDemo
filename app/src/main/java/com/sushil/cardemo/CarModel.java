...
public class CarModel {
    ...
    public CarModel(Long id, String name, String type, String model, String price, String color) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.model = model;
    ...
    public static DiffUtil.ItemCallback<CarModel> ADDRESS_COMPARATOR = new DiffUtil.ItemCallback<CarModel>() {
        @Override
